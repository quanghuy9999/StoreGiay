      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><img src="public/uploads/banner/{{$banner->banner_image}}" height="100" width="300"></td>
            ...
            <td>
              ...
              <a onclick="return confirm('Bạn có chắc muốn xóa?')" href="{{URL::to('/delete-banner/'.$banner->banner_id)}}" class="active styling-edit" ui-toggle-class="">
